...
def cbhg(input, input_lengths, num_banks, hidden_units, num_highway_blocks, norm_type='bn', is_training=True, scope="cbhg"):
    with tf.variable_scope(scope):
        ...
        out = gru(out, hidden_units,True, seqlens=input_lengths)  # (N, T, E)
    return out